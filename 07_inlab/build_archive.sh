...
FILES=(./task1/hazard.s ./task2/unroll4.s ./task2/unroll2.s ./task2/loop.s ./task3/general.s ./task4/matmul.c ./task5/chrono_demo.cpp ./task6/timing.s ./task7/dotprod.cpp)
